        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              id="title"
              {...register("title")}
              className="w-full p-3 bg-slate-800 border border-blue-700 text-white rounded focus:outline-none"
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 p-3 bg-slate-800 border border-blue-700 text-white rounded-l focus:outline-none"
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {tags.map((tag) => (
                <span
                  key={tag}
                  className="text-white border-1 border-slate-400 px-3 py-1 rounded-full flex items-center "
                >
                  {tag}
                  <button
                    type="button"
