...
// Animation variants (same as CreateArticle)
const fadeIn = {
...
const EditArticle = () => {
  ...
  const updateArticleMutation = useMutation({
    mutationFn: updateTrainerArticle,
    onSuccess: () => {
      showToast(STATUS.SUCCESS, SUCCESS_MESSAGES.ARTICLE_UPDATED);
      navigate("/trainer/articles");
    },
    onError: () => {
      showToast(STATUS.ERROR, WARNING_MESSAGES.ARTICLE_UPDATE_FAILED);
    },
  });
  ...
  const onSubmit = async (data: ArticleFormData) => {
    ...
    updateArticleMutation.mutate(articleObject);
  };

  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="animate-pulse bg-gray-200 h-64 w-3/4 rounded-lg"></div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 overflow-hidden">
      ...
      <div className="relative py-24 bg-gradient-to-r from-blue-600/90 to-purple-600/90">
        ...
        >
          ...
          >
            Update your article to share your knowledge
          </motion.p>
        </motion.div>
      </div>
