    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-6">
          <div className="w-12 h-12 border-4 border-t-indigo-500 border-gray-200 rounded-full animate-spin mx-auto mb-4"></div>
          ...
          {subscription && (
            <div className="space-y-4 mb-8">
              <div className="border-b pb-4">
                <h2 className="text-sm text-gray-500 mb-1">Plan</h2>
