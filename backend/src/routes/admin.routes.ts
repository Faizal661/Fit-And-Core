...
router.get('/user-count',verifyAccessToken,authorizeRoles(["admin"]),(req,res,next)=>adminController.userCount(req,res,next))
router.get('/trainer-count',verifyAccessToken,authorizeRoles(["admin"]),(req,res,next)=>adminController.trainerCount(req,res,next))
